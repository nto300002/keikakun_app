...
\restrict MmnNzkTdMwDjPhhNsWqTxRAwWdj2469pHlqyDyL9Z9lXW0Ua6D0sH0D72yvGTPO
...
CREATE MATERIALIZED VIEW public.dashboard_summary AS
 SELECT wr.id,
    ...
    spc.cycle_number,
        CASE
            WHEN (spc.next_renewal_deadline < CURRENT_TIMESTAMP) THEN 'overdue'::text
            WHEN (spc.next_renewal_deadline < (CURRENT_TIMESTAMP + '30 days'::interval)) THEN 'upcoming'::text
            ELSE 'normal'::text
        END AS deadline_status
   FROM ((public.welfare_recipients wr
     JOIN public.office_welfare_recipients owr ON ((wr.id = owr.welfare_recipient_id)))
     LEFT JOIN public.support_plan_cycles spc ON (((wr.id = spc.welfare_recipient_id) AND (spc.is_latest_cycle = true))))
  WITH NO DATA;
...
--
-- Name: welfare_recipients_partitioned; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.welfare_recipients_partitioned (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    first_name character varying(255) NOT NULL,
    last_name character varying(255) NOT NULL,
    birth_day date NOT NULL,
...
--
-- Name: welfare_recipients_part_0; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.welfare_recipients_part_0 (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    first_name character varying(255) NOT NULL,
    last_name character varying(255) NOT NULL,
    birth_day date NOT NULL,
...
--
-- Name: welfare_recipients_part_0; Type: TABLE ATTACH; Schema: public; Owner: -
--

ALTER TABLE ONLY public.welfare_recipients_partitioned ATTACH PARTITION public.welfare_recipients_part_0 FOR VALUES WITH (modulus 4, remainder 0);
...
--
-- Name: welfare_recipients_partitioned welfare_recipients_partitioned_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.welfare_recipients_partitioned
    ADD CONSTRAINT welfare_recipients_partitioned_pkey PRIMARY KEY (id);


--
-- Name: welfare_recipients_part_0 welfare_recipients_part_0_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.welfare_recipients_part_0
    ADD CONSTRAINT welfare_recipients_part_0_pkey PRIMARY KEY (id);
...
--
-- Name: idx_dashboard_summary_office_deadline; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_dashboard_summary_office_deadline ON public.dashboard_summary USING btree (office_id, next_renewal_deadline);


--
-- Name: idx_dashboard_summary_office_furigana; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_dashboard_summary_office_furigana ON public.dashboard_summary USING btree (office_id, last_name_furigana, first_name_furigana);
...
--
-- Name: idx_support_plan_cycles_latest_renewal; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_support_plan_cycles_latest_renewal ON public.support_plan_cycles USING btree (welfare_recipient_id, next_renewal_deadline) WHERE (is_latest_cycle = true);
...
--
-- Name: welfare_recipients_part_0_pkey; Type: INDEX ATTACH; Schema: public; Owner: -
--

ALTER INDEX public.welfare_recipients_partitioned_pkey ATTACH PARTITION public.welfare_recipients_part_0_pkey;
...
\unrestrict MmnNzkTdMwDjPhhNsWqTxRAwWdj2469pHlqyDyL9Z9lXW0Ua6D0sH0D72yvGTPO
