...
| Phase | 焦点 | クエリ数 (500事業所) | 時間 (500事業所) | 改善 |
|-------|------|---------------------|-----------------|------|
| **Baseline** | - | 1,001 | 1,500秒 (25分) | - |
| **Phase 1** | テスト追加 | 1,001 | 1,500秒 | - |
| **Phase 2** | バッチクエリ | **6** | 1,500秒 | **167倍** (クエリ) |
| **Phase 4.1** | 並列処理 | 6 | **150秒 (2.5分)** | **10倍** (時間) |
| **Phase 4.2** | Push最適化 | **4** | 150秒 | 微改善 |
| **最終** | - | **4** | **150秒** | **1,670倍総合** |
