...
ALTER TABLE staffs ADD COLUMN is_deleted BOOLEAN NOT NULL DEFAULT false;
ALTER TABLE staffs ADD COLUMN deleted_at TIMESTAMP WITH TIME ZONE;
ALTER TABLE staffs ADD COLUMN deleted_by UUID;
...
CREATE INDEX ix_staff_audit_logs_staff_id ON staff_audit_logs(staff_id);
CREATE INDEX ix_staff_audit_logs_action ON staff_audit_logs(action);
CREATE INDEX ix_staff_audit_logs_performed_by ON staff_audit_logs(performed_by);
CREATE INDEX ix_staff_audit_logs_created_at ON staff_audit_logs(created_at);
