...
\restrict UsyPwlmkflLQKCR4CTOLQRAVaZQEn5gbbJ7VPzDERDaHCeWQLhDCeiEP0NCq0ZX
...
CREATE TABLE public.message_audit_logs (
    ...
    error_message text,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    version boolean DEFAULT false NOT NULL,
    is_test_data boolean DEFAULT false NOT NULL
);
...
--
-- Name: office_count; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.office_count (
    count bigint
);
...
--
-- Name: staff_count; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.staff_count (
    count bigint
);
...
\unrestrict UsyPwlmkflLQKCR4CTOLQRAVaZQEn5gbbJ7VPzDERDaHCeWQLhDCeiEP0NCq0ZX
